      ...
      switch (apiInfo.current.condition.text) {
        case "Partly cloudy":
          document.body.style.backgroundImage =
            'url("/Weather App/Images/PartlyCloudy.jpg")';
          break;
        case "Clear":
          document.body.style.backgroundImage =
            'url("/Weather App/Images/clear.jpg")';
          break;
        case "Rain":
          document.body.style.backgroundImage =
            'url("/Weather App/Images/rain.jpg")';
          break;
        case "Mist":
          document.body.style.backgroundImage =
            'url("/Weather App/Images/mist.jpg")';
          break;
        case "Snow":
          document.body.style.backgroundImage =
            'url("/Weather App/Images/snow.jpg")';
          break;
        default:
          document.body.style.backgroundImage =
            'url("/Weather App/Images/PartlyCloudy.jpg")';
...
sbmt.addEventListener('click', fetchWeatherData);
